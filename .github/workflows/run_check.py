...
REQ_PROMPT = """
Given the file '{dir}', infer the purpose of the python program. Then, generate feedback for the program. Finally, write the generated feedback to a file named 'feedback.txt'.
"""
